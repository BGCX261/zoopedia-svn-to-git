...
include 'connection.php';
	...
	$flag=0;
	$arr= array();
$result = mysql_query("SELECT name FROM `animals` WHERE type=\"fish\"", $db);
	if (!$result) {
      ...
      <h2 class="p2" style="font-size:100px;">ZooPedia</h2>
        <nav>  
            <div id="slide">		
                <div class="slider">
                    <ul class="items">
                        <li><img src="images/slide/guitarfish-1.jpg" alt="" /></li>
                        <li><img src="images/slide/goatfish-1.JPG" alt="" /></li>
                        <li><img src="images/slide/shark-1.jpg" /></li>
                        <li><img src="images/slide/stingray-2.jpg" /></li>
                    </ul>
                </div>	
  ...
  <span class="body2">
    ...
    <section id="content"><div class="ic"></div>
        <div class="container_12">
          <div class="grid_8">
            <div class="block-1 top-5" style="width:950px"><div class="block-1-shadow">
...
<input name="all" type="radio" value="1" checked hidden="true">
            	...
            	<h2 class="clr-6 p6">Fish</h2>
               	  <font style=" font-family:Andalus; color:#000; font-size:25px; font-stretch:ultra-expanded; ">
               	  <strong> All Fish:</strong><br><br>
•	&nbsp;Live in water.<br>
•	&nbsp;Are vertebrates (which means they have a backbone or spine)<br>
•	&nbsp;Breathe using gills. They absorb oxygen through the gills.<br>
•	&nbsp;Are ectothermic. Almost all fish are cold-blooded. Two of the exceptions are the tuna and the Pacific salmon shark, which can raise their body temperature to some degree.<br>
•	&nbsp;Some fish have scales.<br>
<br>
<br>

 <strong>Below are some Fish .. to know more about them click on their names</strong></font>
<br>
<br>
  <h2 class="clr-6">
