...
$result = mysql_query("SELECT name FROM `animals` WHERE type=\"amphibians\"", $db);
	if (!$result) {
      ...
      <h2 class="p2" style="font-size:100px;">ZooPedia</h2>
        <nav>  
            <div id="slide">		
                <div class="slider">
                    <ul class="items">
                        <li><img src="images/slide/bpf-1.jpg" alt="" /></li>
                        <li><img src="images/slide/caecilian-2.jpg" alt="" /></li>
                        <li><img src="images/slide/salamander-2.jpg" alt="" /></li>
                        <li><img src="images/slide/wtf-1.jpg" alt="" /></li>
                        <li><img src="images/slide/ylf-1.jpg" alt="" /></li>
...
<input name="all" type="radio" value="1" checked hidden="true">
                	...
                	<h2 class="clr-6 p6">Amphibians</h2>
               	 <font style=" font-family:Andalus; color:#000; font-size:25px; font-stretch:ultra-expanded; ">
                  There are three main groups of amphibians: caecilians; salamanders, newts, and mudpuppies; and frogs and toads.<br><br>
               	 <strong>All amphibians:</strong><br><br>
...
•	&nbsp;Breathe through their skin.<br>
•	&nbsp;Go through metamorphosis. Young amphibians hatch from eggs, but do not look like their parents. As they develop, their body shape changes.<br>
<br>
<br>
<strong> Below are some Amphibians .. to know more about them click on their names</strong> </font><br><br>
         <h2 class="clr-6">
