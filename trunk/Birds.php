...
include 'connection.php';
	...
	$flag=0;
	$arr= array();
$result = mysql_query("SELECT name FROM `animals` WHERE type=\"birds\"", $db);
	if (!$result) {
      ...
      <h2 class="p2" style="font-size:100px;">ZooPedia</h2>
        <nav>  
            <div id="slide">		
                <div class="slider">
                    <ul class="items">
                        <li><img src="images/slide/hummingbird-1.jpg" alt="" /></li>
                        <li><img src="images/slide/eagle-1.jpg" alt="" /></li>
                        <li><img src="images/slide/bee eater-1.JPG" alt="" /></li>
                        <li><img src="images/slide/emu-2.JPG" alt="" /></li>
                        <li><img src="images/slide/flamingo-1.jpg" alt="" /></li>
                        <li><img src="images/slide/finch-1.jpg" alt="" /></li>
                    </ul>
                </div>	
...
<input name="all" type="radio" value="1" checked hidden="true">
            	...
            	<h2 class="clr-6 p6">Birds</h2>
               	   	 <font style=" font-family:Andalus; color:#000; font-size:25px; font-stretch:ultra-expanded; ">
               	  <strong>  All Birds: </strong><br><br>
•	&nbsp;Are vertebrates (which means they have a backbone or spine).<br>
•	&nbsp;•	Are endothermic. Also known as “warm-blooded,” endothermic animals regulate their own body temperature which allows them to live in almost every climate on earth.<br>
•	&nbsp;Have feathers<br>
•	&nbsp;•	Lay eggs with hard, waterproof shells. The parent birds incubate the eggs until they hatch, and care for their young.<br>
<br>
<br>


<strong>Below are some Birds .. to know more about them click on their names </strong> </font>
<br><br>
  <h2 class="clr-6">
